  ...
  return (
    ...
    {/* 🌿 Hero Section */}
      ...
      <section className="max-w-7xl mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6">Top Rated Indoor Plants</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {plants
            .sort((a, b) => b.rating - a.rating)
            .map((plant) => (
              <div key={plant.plantId} className="border rounded-lg p-4 hover:shadow-lg transition">
                <img src={plant.image} alt={plant.plantName} className="w-full h-48 object-cover rounded-md mb-2" />
                ...
                <button className="mt-2 w-full btn btn-primary">View Details</button>
              </div>
            ))}
        </div>
      </section>
